...
import com.syjjkj.kxwq.wheel.NumericWheelAdapter;
import com.syjjkj.kxwq.wheel.OnWheelChangedListener;
import com.syjjkj.kxwq.wheel.WheelView;

import java.text.SimpleDateFormat;
import java.util.Calendar;
import java.util.Date;

public class DateWheelView extends PopupWindow implements OnClickListener {
	...
	public DateWheelView(Activity context, WheelDate wheelDate) {
		super(context);
		mContext = context;
		this.wheelDate = wheelDate;
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		this.age = sdf.format(new Date());
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.date_wheel_birthday, null);
