...
public class GridViewInterceptor extends GridView{
	...
	private int dragndropBackgroundColor = 0x00000000;//拖拽时背景颜色为透明
...
/**
 * 当我们点击GridView的Item,先会去执行dispatchTouchEvent()方法将事件分发下去，所以我们要重写dispatchTouchEvent()
 * 方法在手指按下的时候根据pointToPosition()方法来获取我们按下的item的position,根据getChildAt()方法来获取该position上面所对应的View, 
 */
		...
		// TODO Auto-generated method stub
				...
				if ((mDropListener != null) && mDragView != null) {
					...
					case MotionEvent.ACTION_CANCEL:
						...
						break;
					/**
					 * getRawX(),getRawY()和getX(),getY()的区别，
					 * getRawX(),getRawY()是相对于屏幕的原点的距离，
					 * 而getX(),getY()是相对于控件左上方的点的距离
					 */
...
//							adjustScrollBounds(y);
							...
							} else if ((y - mDragPointY + mItemHeightNormal + mCoordOffsetY) > mHeight) {
								// out of bottom.
								// t = mDragFrameHeight -
...
//	}
/**
 * 在手指按下的时候根据pointToPosition()方法来获取我们按下的item的position,
 * 根据getChildAt()方法来获取该position上面所对应的View,
 */
	@Override
 ...
 */
	...
	public void delDrawCache(int pos)
	{
